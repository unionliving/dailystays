                  ...
                  <div className="grid grid-cols-2 gap-x-6 gap-y-4 mb-8 text-gray-500 font-[GaretRegular] text-xs">
                    {room.guests && (
                      <div className="flex flex-col border-l border-gray-200 pl-3">
                        <span className="text-[0.6rem] uppercase tracking-widest text-gray-400 mb-0.5">Capacity</span>
                    ...
                    {room.spare && (
                      <div className="flex flex-col border-l border-gray-200 pl-3">
                        <span className="text-[0.6rem] uppercase tracking-widest text-gray-400 mb-0.5">Additional</span>
                        <span className="text-gray-900">{room.spare}</span>
                      </div>
                    )}
                    {room.kid && (
                      <div className="flex flex-col border-l border-gray-200 pl-3">
                        <span className="text-[0.6rem] uppercase tracking-widest text-gray-400 mb-0.5">Kids</span>
                        <span className="text-gray-900">{room.kid}</span>
                      </div>
                    )}
                    {room.bathroom && (
                      <div className="flex flex-col border-l border-gray-200 pl-3">
